...
<?php
  ...
  $result = mysqli_query($con,"Select * From sagar_ratna Where ITEM = '$item'"); 
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
 ...
 <article>
    <div id='bill'>
   <p><h3><i class="fa fa-shopping-bag" style="font-size:20px; color:orange"><b> From SAGAR RATNA</b></i></h3></p>
   <p><i class="fa fa-map-marker" style="font-size:20px"></i><b>1st Floor, The Starling Mall, Hazipur, Sector 104, Noida</b></p>
