...
<?php
  ...
  $result = mysqli_query($con,"Select * From dominos Where ITEM = '$item'"); 
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
 ...
 <article>
    <div id='bill'>
   <p><h3><i class="fa fa-shopping-bag" style="font-size:20px; color:orange"><b> From DOMINO'S</b></i></h3></p>
   <p><i class="fa fa-map-marker" style="font-size:20px"></i><b> C 2/22, SECTOR-18, G Block, Noida</b></p>
